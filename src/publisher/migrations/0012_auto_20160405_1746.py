...
class Migration(migrations.Migration):
    ...
    dependencies = [("publisher", "0011_auto_20160405_1628")]
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name="historicalarticle", name="datetime_published"
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                default=1, on_delete=models.deletion.CASCADE, to="publisher.Article"
            ),
