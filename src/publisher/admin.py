...
class UnpublishedVersionsFilter(admin.SimpleListFilter):
    ...
    def queryset(self, request, queryset):
        if self.value() != "unpublished":
            return
        return (
            queryset.annotate(num_avs=Count("articleversion"))
...
admin_list = [(models.Publisher,), (models.Journal,), (models.Article, ArticleAdmin)]
