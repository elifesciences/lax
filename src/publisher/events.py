...
def add(art, event, value=None, datetime_event=None):
    ...
    struct = {"event": event, "value": str(value), "datetime_event": datetime_event}
    create = update = True
    ae, created, updated = create_or_update(
        models.ArticleEvent,
        struct,
        ["article", "event", "datetime_event"],
        create,
        update,
        article=art,
    )
...
EJP_EVENTS = [
    {
        ...
        "datetime_event": [p("date_initial_qc"), todt, dropnil],
        "value": ["initial"],
    },
    {
    ...
    {
        "event": [models.DATE_EJP_QC],
        "datetime_event": [p("date_full_qc"), todt, dropnil],
        "value": ["full"],
    },
    {
        "event": [models.DATE_EJP_DECISION],
    ...
    {
        "event": [models.DATE_EJP_QC],
        "datetime_event": [p("date_rev1_qc"), todt, dropnil],
        "value": ["rev1"],
    },
    {
        "event": [models.DATE_EJP_DECISION],
    ...
    {
        "event": [models.DATE_EJP_QC],
        "datetime_event": [p("date_rev2_qc"), todt, dropnil],
        "value": ["rev2"],
    },
    {
        "event": [models.DATE_EJP_DECISION],
    ...
    {
        "event": [models.DATE_EJP_QC],
        "datetime_event": [p("date_rev3_qc"), todt, dropnil],
        "value": ["rev3"],
    },
    {
        "event": [models.DATE_EJP_DECISION],
    ...
    {
        "event": [models.DATE_EJP_QC],
        "datetime_event": [p("date_rev4_qc"), todt, dropnil],
        "value": ["rev4"],
    },
    {
        "event": [models.DATE_EJP_DECISION],
