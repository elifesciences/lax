...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='article',
            name='slug',
            field=autoslug.fields.AutoSlugField(populate_from=b'title', editable=False, always_update=True, blank=True, help_text=b'A friendlier version of the title for machines', null=True),
        ),
        migrations.AlterField(
            model_name='article',
            name='version',
